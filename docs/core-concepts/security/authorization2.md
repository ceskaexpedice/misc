# Core Concepts – Práva a vyhodnocování akcí

Tato stránka popisuje **jak Kramerius vyhodnocuje oprávnění k jednotlivým akcím** (např. READ, WRITE, EXPORT).

Je to doplněk k [Core Concepts – Security](Security), kde jsou popsáni uživatelé a role.
...
- [Core Concepts – Security](Security) – uživatelé, role, autentizace
- [Licence](Licence.md) – detailní popis typů licencí
- [Guides – Administrátor](Guides_Security) – praktické scénáře
