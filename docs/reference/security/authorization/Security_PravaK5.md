...
![Datový model](assets/rights/prava-wiki-secversion.png)
...
![Hierarchie](assets/rights/fedora-obj-tree.png)
...
![Sbírky](assets/rights/collections-path.png)
...
![Příklad](assets/rights/prava-scenardefault.png)
...
![Moving wall](assets/rights/prava-scenarmw.png)
...
![Předplatitelé](assets/rights/prava-scenarpredplatitele.png)
...
![IP adresy](assets/rights/prava-scenarexcluisveips.png)
